...
public class Location implements Comparable
{
    ...
    /**
     * Indicates whether some other <code>source.Location</code> object is "equal to"
     * this one.
     * @param other the other location to test
     * @return <code>true</code> if <code>other</code> is a
     * <code>source.Location</code> with the same row and column as this location;
     ...
     * (Precondition: <code>other</code> is a <code>source.Location</code> object.)
     * @param other the other location to test
